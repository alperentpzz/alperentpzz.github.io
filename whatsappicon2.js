function CreateWhatsappChatWidget(option = {
    ...
    function initWidget(){
        ...
        jQuery('body').append(`<div id="whatsapp_chat_widget">
            <div id="wa-widget-send-button" style="left: 20px;">
        ...
        jQuery('#whatsapp_chat_widget').append(`
            <div class='wa-chat-box' style="display: block; left: 30px;">
                ...
                <div class='wa-chat-box-send'>
                    ...
                    <div class='wa-chat-box-poweredby'><a href="https://alonedarks.com/" target="_blank" style="color: #006eff6e;">Alonedarks.com</a></div>
                </div>
            </div>
        `);
